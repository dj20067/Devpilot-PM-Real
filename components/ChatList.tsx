  ...
  return (
    <div className="w-72 bg-slate-50/50 dark:bg-surface-dark border-r border-border-light dark:border-border-dark flex flex-col shrink-0">
      <div className="flex items-center justify-between px-2 h-12 border-b border-border-light dark:border-border-dark bg-surface-light dark:bg-surface-dark">
        <button className="flex-1 text-center h-full relative text-red-500 font-medium">
          会话中 (1)
          <span className="absolute bottom-0 left-0 w-full h-0.5 bg-red-500"></span>
        </button>
        <button className="flex-1 text-center h-full text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200">
          排队中 (0)
        </button>
        <button className="flex-1 text-center h-full text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200">
          已结束
